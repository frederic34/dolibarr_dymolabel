    ...
    function onload()
    {
        ...
        function updatePreview() {
            try {
                ...
                label.setObjectText('Codebarre', barcode.value);
                label.setObjectText('Reference', reference.value);
                label.setObjectText('Libelle', libelle.value);
        ...
        printButton.onclick = function()
        {
            try
            {
                ...
                record.setText('Codebarre', barcode.value);
                record.setText('Reference', reference.value);
                record.setText('Libelle', libelle.value);
        ...
        {                     
            ...
            $.get("Product.label", function(labelXml)
            {
